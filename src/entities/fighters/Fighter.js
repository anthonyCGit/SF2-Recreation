import { FighterState, FIGHTER_DIRECTION, FIGHTER_START_DISTANCE, FrameDelay, PUSH_SPEED } from "../../constants/fighter.js"
...
export class Fighter {
    constructor (name, playerID) {
        ...
        this.direction = playerID == 0 ? FIGHTER_DIRECTION.RIGHT : FIGHTER_DIRECTION.LEFT;
        this.gravity = 0;
        ...
        this.states = {
            [FighterState.IDLE]: {
                ...
                validFrom: [
                    undefined,
                    FighterState.IDLE, FighterState.WALK_FORWARD, FighterState.JUMP_FORWARD,
                    FighterState.JUMP_UP, FighterState.WALK_BACKWARD, FighterState.JUMP_BACKWARD,
            ...
            [FighterState.JUMP_LAND]: {
                ...
                validFrom: [
                    FighterState.JUMP_UP, FighterState.JUMP_BACKWARD, FighterState.JUMP_FORWARD,
                ],
            },
            [FighterState.CROUCH]: {
                init: () => {},
    ...
    updateStageConstraints(time, context, camera) {
        ...
        if (this.hasCollidedWithOpponent()) {
            if (this.position.x <= this.opponent.position.x) {
                ...
                if ([FighterState.IDLE, FighterState.CROUCH, FighterState.JUMP_UP,
                    FighterState.JUMP_BACKWARD, FighterState.JUMP_FORWARD,].includes(this.opponent.currentState)) {
                    this.opponent.position.x += PUSH_SPEED * time.secondsPassed;
                }
            }
